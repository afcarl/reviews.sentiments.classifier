function googlenewsoutput = importGoogleNewsLabels(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   GOOGLENEWSOUTPUT = IMPORTFILE1(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   GOOGLENEWSOUTPUT = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   googlenewsoutput = importfile1('google_news_output.txt', 3, 3000000);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/02/19 22:55:50
